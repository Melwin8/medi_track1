"""
Django settings for medi_track1 project.
...
SECRET_KEY = 'django-insecure-+%^x92p6^ifd05a@sv#d(0l52rp$(c&2k!r68l7spjw**(uk$l'
...
WSGI_APPLICATION = 'medi_track1.wsgi.application'
